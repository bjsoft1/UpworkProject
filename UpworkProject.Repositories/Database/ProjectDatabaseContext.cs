...
namespace UpworkProject.Repositories.Database
{
    public class ProjectDatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ParticipaintInformation>(entity =>
            {
                ...
                entity.Property(e => e.Hobbies).IsRequired(false);
        ...
        private List<DynamicControl> GetDynamicControls()
        {
            return new List<DynamicControl>
            {
                ...
                new DynamicControl { Id = 2, ControlIdentity = "Gender", ControlType = EDynamicControlTypes.RadioButton, LabelDate = "What is your gender?", OrderNumber = 2, Status = EDataStatus.Active, Options = "Male,Female"},
                new DynamicControl { Id = 3, ControlIdentity = "Hobbies", ControlType = EDynamicControlTypes.CheckBox, LabelDate = "What is your hobbies?", OrderNumber = 3, Status = EDataStatus.Active, Options = "Music,Movies,Sports" },
                new DynamicControl { Id = 4, ControlIdentity = "Country", ControlType = EDynamicControlTypes.SelectionBox, LabelDate = "What is your country name?", OrderNumber = 4, Status = EDataStatus.Active, Options = "Nepal,India,China,USA,Korea,Japan,Pakistan" },
